...
//        public Vector2 HorizontalVector => new Vector2((float)Latitude, (float)Longitude);
...
//        /// <param name="l"></param>
//        /// <returns></returns>
//        public static Vector3 LocationToEcef(Location l)
//        {
...
//            Debug.Log("displacementPosition :" + displacementPosition);
...
//        }
//    }
//    internal class GPSLocationConverter : MonoBehaviour
//    {
...
//        public static Vector2 VectorFromToEcefEnu(Location l1, Location l2)
//        {
//            var rad = Math.PI / 180;
//            var lat = l1.Latitude * rad;
//            var lon = l1.Longitude * rad;
